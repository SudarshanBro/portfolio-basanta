...
const Index = () => {
  const socials = [
    { name: "LinkedIn", url: "#" },
    { name: "Email", url: "mailto:basantaacharya1403@gmail.com" },
    { name: "GitHub", url: "https://www.github.com/SudarshanBro" },
    { name: "Instagram", url: "https://www.instagram.com/bas_anta_8" },
  ];
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="text-sm text-muted-foreground">
            © 2025. Mahesh Acharya. All rights reserved.
          </div>
        </div>
      </motion.footer>
    </div>
